...
public class DeviceDTO {
    ...
    public DeviceDTO(UUID id, String name, String description, String address, double maxConsumption, UUID userId) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(that.maxConsumption, maxConsumption) == 0 &&
